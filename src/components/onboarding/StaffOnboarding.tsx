  ...
  return (
    <div className="flex h-1">
      {Array.from({ length: TOTAL_STEPS }, (_, index) => (
        <div key={index} className={`flex-1 ${index < step ? "bg-brand-accent" : "bg-black/15"}`} />
      ))}
    </div>
  );
}
  ...
  return (
    <main className="flex min-h-full flex-1 flex-col">
      ...
      <div className="mx-auto flex w-full max-w-sm flex-1 flex-col px-6 py-10">
        ...
        <p className="mt-6 text-xs font-semibold tracking-wide uppercase opacity-60">Step 1 of 3</p>
        ...
        <div className="mt-auto pt-8">
          <button
            type="button"
            onClick={onContinue}
            className="w-full bg-brand-accent px-4 py-3 text-sm font-semibold text-brand-accent-foreground"
          >
            Continue
          </button>
        </div>
...
function PasswordStep({ onContinue }: { onContinue: () => void }) {
  ...
  return (
    <main className="flex min-h-full flex-1 flex-col">
      <ProgressBar step={2} />
      <div className="mx-auto flex w-full max-w-sm flex-1 flex-col px-6 py-10">
        <p className="text-xs font-semibold tracking-wide uppercase opacity-60">Step 2 of 3</p>
  ...
  return (
    <main className="flex min-h-full flex-1 flex-col">
      ...
      <div className="mx-auto w-full max-w-sm flex-1 px-6 py-10">
        <p className="text-xs font-semibold tracking-wide uppercase opacity-60">Step 3 of 3</p>
